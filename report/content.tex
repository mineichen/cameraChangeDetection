...
\section{Bump}
The algorithm works very precisely in that situation. It hasn't missed a single bump and reaches 0 false negatives and 0 false positives. All project goals are achieved.
